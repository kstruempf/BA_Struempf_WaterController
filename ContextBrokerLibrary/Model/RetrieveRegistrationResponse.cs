...
namespace ContextBrokerLibrary.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RetrieveRegistrationResponse : IEquatable<RetrieveRegistrationResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveRegistrationResponse" /> class.
        /// </summary>
        ...
        public RetrieveRegistrationResponse(string id = default(string), string description = default(string),
            ...
            string status = default(string), Object forwardingInformation = default(Object))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException(
                    "id is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException(
                    "description is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "dataProvided is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "provider is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "expires is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "status is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException(
                    "forwardingInformation is a required property for RetrieveRegistrationResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as RetrieveRegistrationResponse);
        }

        /// <summary>
        /// Returns true if RetrieveRegistrationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RetrieveRegistrationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetrieveRegistrationResponse input)
        {
            if (input == null)
                return false;
